public class Perusahaan {
    ...
    Perusahaan(){
        ...
        Barang PerawatanPenganten = new Barang(4,"Perawatan Penganten", 8500,"Rempah2","70 (1kg : 50x pakai)=3500",20000);
        Barang MakeupAcaraPesta = new Barang(5,"Makeup acara pesta", 50000,"Rempah2","750 (1kg : 200x pakai)=15000",200000);
        Barang PewarnaanRambut  = new Barang(6,"Pewarnaan Rambut ", 55000,"Rempah2","850 (1kg : 100x pakai)=8500",15000000);
        Barang MenikurDanPedikur  = new Barang(7,"Menikur dan pedikur", 170,"Rempah2","250 (1kg : 200x pakai)=50000",150000);
        Barang PotongRambut = new Barang(8,"Potong rambut", 3500,"Rempah2","275 (1kg : 200x pakai)=55000",125000);
        Barang BlicingBody = new Barang(9,"Blicing body, [dgn suntik vit.C, Vit.E, & Kolagen", 15000,"Rempah2","75 (1kg: 100x pakai)=170",180000);
    ...
    protected void laporanPendapatanBersihPerHari() {
        System.out.println("laporan pendapatan bersih per hari");
    }
}
